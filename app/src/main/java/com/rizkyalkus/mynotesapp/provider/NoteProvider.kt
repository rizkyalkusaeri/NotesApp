package com.rizkyalkus.mynotesapp.provider
...
import com.rizkyalkus.mynotesapp.database.DatabaseContract.AUTHORITY
...
class NoteProvider : ContentProvider() {
    ...
    override fun delete(uri: Uri, selection: String?, selectionArgs: Array<String>?): Int {
        val deleted:Int = if (NOTE_ID == sUriMatcher.match(uri)){
